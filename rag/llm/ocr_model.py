...
class MinerUOcrModel(Base, MinerUParser):
    ...
    def __init__(self, key: str | dict, model_name: str, **kwargs):
        ...
        self.mineru_image_pre_url = _resolve_config("mineru_image_pre_url", "MINERU_IMAGE_PRE_URL", "")
        ...
        MinerUParser.__init__(self, mineru_api=self.mineru_api, mineru_server_url=self.mineru_server_url, mineru_image_pre_url=self.mineru_image_pre_url, mineru_api_token=self.mineru_api_token)
    ...
    def check_available(self, backend: Optional[str] = None, server_url: Optional[str] = None) -> tuple[bool, str]:
        ...
        logging.info(f"[MinerUOcrModel] Checking availability: mineru_api_token={self.mineru_api_token[:10] if self.mineru_api_token else 'None'}...")
