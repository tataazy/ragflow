...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      testResults: 'Results',
      sagSourceTooltip: 'From SAG structured retrieval',
      testSetting: 'Setting',
...
[Insert text here]`,
    ...
    sag: {
      knowledgeGraph: 'SAG Knowledge Graph',
      rebuild: 'Rebuild Graph',
      timeline: 'Timeline',
      filterByType: 'Filter by entity type',
      allTypes: 'All types',
      allDocuments: 'All documents',
      comingSoon3D: '3D view coming soon',
      comingSoonTimeline: 'Timeline view coming soon',
      enableSag: 'Enable SAG',
      enableSagDescription: 'Enable SAG in dataset settings to build the event-entity graph',
      noData: 'No graph data yet',
      noDataDescription: 'Events and entities are extracted after parsing documents, or click rebuild to trigger manually',
      running: 'Building',
      completed: 'Completed',
      failed: 'Build failed',
      idle: 'Idle',
      graph: {
        ...
        stats: '{{events}} events · {{entities}} entities · {{relations}} links',
        aria: 'SAG event-entity graph',
      },
      entityType: {
        时间: 'Time',
        地点: 'Location',
