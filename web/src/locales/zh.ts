...
[在此处插入文本]`,
    ...
    sag: {
      knowledgeGraph: 'SAG 知识图谱',
      rebuild: '重建图谱',
      timeline: '时间线',
      filterByType: '按实体类型筛选',
      allTypes: '全部类型',
      allDocuments: '全部文档',
      comingSoon3D: '3D 视图即将推出',
      comingSoonTimeline: '时间线视图即将推出',
      enableSag: '启用 SAG',
      enableSagDescription: '在知识库配置中启用 SAG 以构建事件-实体图谱',
      noData: '暂无图谱数据',
      noDataDescription: '解析文档后会自动抽取事件和实体，或点击重建手动触发',
      running: '构建中',
      completed: '已完成',
      failed: '构建失败',
      idle: '空闲',
      graph: {
        ...
        treeLayout: '树形布局',
        resetPositions: '重置布局',
        stats: '{{events}} 个事件 · {{entities}} 个实体 · {{relations}} 条关联',
        aria: 'SAG 事件-实体图谱',
      },
      entityType: {
        时间: '时间',
