...
以上就是你需要总结的内容。`,
      ...
      tags: '标签',
      addTag: '增加标签',
      useGraphRagSAG: '启用 SAG GraphRAG',
      useGraphRagSAGTip: '使用 SAG 风格图检索进行多跳问答',
      entityTypes: '实体类型',
      entityTypesTip: '要提取的实体类型：人物、组织、地点、产品、指标等',
      maxHops: '最大跳数',
      maxHopsTip: '图遍历的最大跳数 (0-3)',
      entityTopK: '实体 TopK',
      entityTopKTip: '检索的 top 实体数量',
      multiTopK: '多跳 TopK',
      multiTopKTip: '多跳检索的事件候选数量',
      rerankTopK: '重排 TopK',
      rerankTopKTip: '重排后返回的事件数量',
      maxSections: '最大章节数',
      maxSectionsTip: '返回结果的最大章节数',
      standardMode: '标准模式',
      fastMode: '快速模式',
      standardModeTip: 'LLM 抽取实体，检索更精准',
      fastModeTip: 'BM25 关键词匹配，检索更快',
      graphragSAGTitle: 'SAG GraphRAG',
      graphragSAGDescription: '基于事件-实体关系的图检索',
      graphragSAGBuild: '构建图索引',
      graphragSAGBuildTip: '为 SAG GraphRAG 检索构建图索引',
      graphragSAGStats: '图统计',
      graphragSAGEvents: '事件',
      graphragSAGEntities: '实体',
      graphragSAGRelations: '关系',
      graphragSAGChunks: '块',
      graphragSAGTesting: 'GraphRAG 检索测试',
      graphragSAGTestingDesc: '测试 SAG 风格图检索结果',
